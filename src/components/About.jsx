      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="grid gap-6">
            <div className="bg-[#0f0f0f] p-6 rounded-2xl shadow-lg hover:shadow-green-400/30 transition-all duration-300">
            ...
            <div className="bg-[#0f0f0f] p-6 rounded-2xl shadow-lg hover:shadow-green-400/30 transition-all duration-300">
              <h4 className="text-xl font-semibold">Certified React-JS Frontend Developer</h4>
        ...
        {/* Experience */}
        <div>
          <h3 className="text-2xl font-semibold mb-4 text-green-400">Professional Experience</h3>
          <div className="grid gap-6">
            <div className="bg-[#0f0f0f] p-6 rounded-2xl shadow-lg hover:shadow-green-400/30 transition-all duration-300">
