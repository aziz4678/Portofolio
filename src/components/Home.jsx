...
const Home = () => {
  return (
    <section className="min-h-screen flex items-center justify-between px-12 bg-black font-jetbrains">
      {/* Content Section */}
      <div className="max-w-2xl">
        <p className="text-green-400 mb-4">Frontend Developer</p>
        <h1 className="text-5xl font-bold mb-4 text-white">Hello I'm <span className="text-green-400">Muhamad Aziz</span></h1>
        ...
        <div className="flex gap-12 mb-12 text-white">
          <div>
